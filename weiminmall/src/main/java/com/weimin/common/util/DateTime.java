...
public class DateTime {
	...
	/**
	 * 
	 * @Title: convertDateTime_order_YYYYMMDDHHMMSS_ 
	 * @Description:订单支付时间 
	 * @param currentDate
	 * @return    
	 * @return String   
	 * @author Jh 
	 * @date 2015年3月17日 下午6:37:53
	 */
	public static String convertDateTime_order_YYYYMMDDHHMMSS(Date currentDate) {
		return convertDateTime(currentDate, "yyyyMMddHHmmss");
	}
